...
class ClassName(object):
    def __init__(self, Domain, verbose=False):
        ...
        try:
            ...
            self.logger.critical(
                "ExaleadPPTXSearch module failed to __init__: " + str(e)
            )
            print helpers.color(
                " [*] Major Settings for Exalead are missing, EXITING!\n", warning=True
            )
    ...
    def search(self):
        ...
        while self.Counter <= self.Limit and self.Counter <= 10:
            ...
            try:
                url = (
                    'http://www.exalead.com/search/web/results/?q="%40'
                    + self.Domain
            ...
            try:
                ...
                self.urlList = [
                    h2.a["href"] for h2 in soup.findAll("h4", class_="media-heading")
                ]
            except Exception as e:
        ...
        try:
            for url in self.urlList:
                ...
                try:
                    ...
                    if FileDownload:
                        if self.verbose:
                            p = " [*] Exalead PPTX file was downloaded: " + str(url)
            ...
            print helpers.color(
                " [*] No PPTX's to download from Exalead!\n", firewall=True
            )
