...
class ClassName(object):
    def __init__(self, domain, verbose=False):
        ...
        self.description = (
            "Search GitHubGist code for emails using a large pool of code searches"
        )
        self.domain = domain
        ...
        try:
            ...
            print helpers.color(
                " [*] Major Settings for GitHubGistSearch are missing, EXITING!\n",
                warning=True,
            )
    ...
    def process(self):
        ...
        while self.Counter <= self.Depth:
            ...
            try:
                ...
                url = (
                    "https://gist.github.com/search?p="
                    + str(self.Counter)
                    + "&q=%40"
                    + str(self.domain)
